    ...
    \begin{enumerate}[label=\roman*)]
        ...
        \item 
            ...
            \begin{align*}
                ...
                \frac{\sigma^2}{2}dW^2(t) + h.o.t.\right)
                \\
                &\approx \sigma E(dW(t)) - \frac{\sigma^2}{2}E(dW^2(t))
                \\
                &\approx -\frac{\sigma^2}{2}dt
            \end{align*}
        \item 
            \begin{align*}
                \ddt{E_X} &= 0
            ...
            \end{align*}
            \begin{align*}
                \ddt{E_Y} &= -\frac{\sigma^2}{2}
                \\
                E_Y(t) &= c - \frac{\sigma^2}{2}t
                \\
                E_Y(0) &= 0 
                \\
                E_Y(t) &= -\frac{\sigma^2}{2}t
            \end{align*}
    \end{enumerate}
